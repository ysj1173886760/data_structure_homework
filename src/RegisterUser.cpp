...
int RegisterUser::Register(const std::string& in_account,
    ...
    if (!register_phone_number(in_phone_number)
    || !register_email(in_email)
    || !register_id_number(in_id_number)
    || !register_real_name(in_real_name)) return 3;
